        ...
        <div class="row justify-content-center">
            <div class="col-lg-10 col-xl-9">
                ...
                <div class="card-body markdown">
                    <p>
                        <a href="{{ route('act-editKomentar',$komentar->slug) }}" class="link-secondary"
                            title="Edit komentar"
                            data-bs-toggle="tooltip"
                        ...
                        <form style="margin-top: -46px" class="ms-3" action="{{ route('act-deleteKomentar',$komentar) }}" method="POST">
                            @method('PUT')
                            @csrf
                        ...
                        <div class="container-xl d-flex flex-column justify-content-center">
                            ...
                            <div class="empty">
                                ...
                                <div class="empty-action">
                                    ...
                                    <a href="{{ route('kegiatan.edit',$komentar->slug) }}" class="btn btn-primary">
                                        Isi Komentar
                                    </a>
                                </div>
                            </div>
